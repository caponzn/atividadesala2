...
public class vCadCidade extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnIncluir.setBackground(new java.awt.Color(153, 153, 153));
        btnIncluir.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        ...
        btnPesquisar.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        ...
        cmbEstado.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        cmbEstado.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Minas Gerais", "São Paulo", "Rio de Janeiro", "Espirito Santo" }));
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        new vPesquisarCidade(null, true).setVisible(true);
